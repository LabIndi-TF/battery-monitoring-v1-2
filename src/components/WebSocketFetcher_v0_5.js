...
// var linkBuffer = 'http://localhost:5000/api/buffer'
/*
seharusnya linkBuffer ditulis seperti yg di-comment out, 
tetapi bisa dipotong seperti itu. Trik : pada package.json diambahkan
"proxy": "http://localhost:5000" pada object package 
*/
